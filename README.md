...
신뢰 출처 우선순위도 적용되어 있습니다. 교육부 정책브리핑, UNESCO-UNEVOC, EdSurge, The 74, eSchool News, K-12 Dive처럼 직접 RSS가 가능한 출처를 먼저 수집하고, KERIS, OECD, UNESCO, Education Week, EdTech Magazine 등은 Google News RSS를 보조 검색으로 사용합니다. 화면 정렬과 에이전트 검색에서도 공식 기관/국제기구/전문 교육매체를 우선 참고하도록 구성했습니다. Google News RSS의 실제 매체명도 함께 읽어 `source`에 반영합니다.
